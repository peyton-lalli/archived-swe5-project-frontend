  ...
  <v-card ref="form">
    ...
    <v-card-actions>
      ...
      <v-btn
        ...
        class="font-weight-bold"
        color="darkerGreen"
        @click="closeDialog(), openSnackbar(course.courseNumber + ' Saved.')"
        >Save</v-btn
      >
    </v-card-actions>
  </v-card>
...
export default {
  ...
  data() {
    return {
      ...
      courseSemester: this.course.courseSemester,
      courseLab: this.course.courseLab,
      coursePrereq: this.course.coursePrereq,
